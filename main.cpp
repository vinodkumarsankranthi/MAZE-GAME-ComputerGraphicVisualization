 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(5,160,"         HKES SLN COLLEGE OF ENGINEERING RAICHUR");
	glColor3f(1,1,1);
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"Vinodkumar Sankranthi(3SL19CS055) AND Mahemood Hussain(3SL19CS050) ");

	output(40,80,"");
	glColor3f(1,0,1);
	output(40,60,"Under the Guidence of Vijayakumari G :");
	glBegin(GL_LINES);
	glVertex2f(40,58);
	glVertex2f(98,58);
	glEnd();
 ...
 void winscreen()
 {
	...
	output(15,100,"YOU HAVE SUCCEEDED IN FINDING OUT THE PATH");
     ...
     output(35,45,"* PRESS RIGHT CLICK TO RESTART THE GAME");
	glFlush();
 }
void startscreen()
{
...
output(50,100,"1.NEW GAME OR CLICK LEFT BUTTON");
...
void instructions()
{
  ...
  output(-20,20,"* PRESS ESC TO GO TO MAIN MENU AND PRESS RIGHT BUTTON TO RESTART THE GAME");
   glFlush();
}
...
void timeover()
{
 ...
 output(40,30,"* PRESS RIGHT CLICK TO RESTART THE GAME");
 glFlush();
}
...
if(df==10&& btn==GLUT_LEFT_BUTTON && GLUT_DOWN )
df=0;

    else if((df==0 || df==4 || df==5))
   {
     df=1;
     start=clock();
	 glutPostRedisplay();
